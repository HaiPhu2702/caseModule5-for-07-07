            ...
            try {
                ...
                const changeName=async ()=>{
                    const res = await axios.post(
                        `${REACT_APP_API_URL}/users/change-name/` + action.payload.id,
                        action.payload.inputChangeName
                    );
                }
                changeName()
                state.profile.name = action.payload.inputChangeName
            } catch (error) {
                throw error.message;
            }
        },
...
export const {setAuth, logout, changeUserName} = authSlice.actions;
