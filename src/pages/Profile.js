...
import {changeUserName, getProfile} from "../redux/slices/authSlice";
    ...
    return (
        <Box>
           ...
           <span style={{display: "flex", alignItems: "center"}}>
             <div><h3 style={{marginRight: "7rem"}}>{profile.name}</h3></div>
             {/*<div><ChangeNameUser/></div>*/}
           </span>
                        <button onClick={() => {
                            setChangeName(true)
                            setClose(true)
                        ...
                        {Save
                            &&
                            <button onClick={() => {
                                dispatch(changeUserName({id:id,inputChangeName:inputChangeName}))
                                setChangeName(false)
                                setClose(false)
                                setSave(false)
                            }}
